...
public class UserPublicProfileController {
    ...
    public Result<UserPublicProfileResponse> getPublicProfile(@PathVariable Long userId) {
        return Result.success(userPublicProfileService.getPublicProfile(userId));
    }
    ...
    public Result<PageResponse<POIShareResponse>> getUserPublicShares(
        ...
        return Result.success(userPublicProfileService.getUserPublicShares(userId, page, size));
    }
    ...
    public Result<PageResponse<UserCheckInItemResponse>> getUserCheckIns(
            ...
            @RequestParam(required = false) Integer page,
            @RequestParam(required = false) Integer size) {
        return Result.success(userPublicProfileService.getUserCheckIns(userId, page, size));
    }
}
